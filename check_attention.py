...
def parse_args():
    ...
    parser.add_argument('--lambda', type=float, default=0.5, dest='lambda_att')
    ...
    parser.add_argument('--attn_diag_threshold', type=float, default=0.01)
    parser.add_argument('--attn_diag_top_k', type=int, default=5)
    parser.add_argument('--attn_export_csv', type=str, default=None,
                        help='Path to export per-item attention scores as CSV')
