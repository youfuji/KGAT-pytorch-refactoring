...
def parse_akdn_args():
    parser = argparse.ArgumentParser(description="Run AKDN.")
    ...
    # AKDN用の保存ディレクトリ設定
    # 構成要素: データセット名, 次元数, レイヤー構成, 学習率, 事前学習フラグ
    save_dir = 'trained_model/AKDN/{}/embed-dim{}_relation-dim{}_{}_lr{}_pretrain{}/'.format(
